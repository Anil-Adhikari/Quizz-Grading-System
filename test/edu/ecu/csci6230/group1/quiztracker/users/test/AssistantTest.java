...
public class AssistantTest {
	...
	public static final String fullName = "Worker Bee";
	public static final String firstName = "Worker";
	public static final String lastName = "Bee";
	public static final String userId = "wbee";
	public static final String password = "wbee123";
	private Assistant asst;
	...
	public void testAssistant() {
		asst = (Assistant) UserManager.verifyUser(userId, password);
		assertEquals(fullName, asst.getFullname());
	}
